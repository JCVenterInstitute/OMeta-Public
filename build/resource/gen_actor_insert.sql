...
FROM actor
WHERE (date(actor_create_date)=CURRENT_DATE()-INTERVAL 1 DAY or date(actor_modify_date)=CURRENT_DATE()-INTERVAL 1 DAY or
  date(actor_create_date)=CURRENT_DATE() or date(actor_modify_date)=CURRENT_DATE())
;