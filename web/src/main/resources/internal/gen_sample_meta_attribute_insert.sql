...
-- select sma.* from dod_ometa. project p, dod_ometa. sample_meta_attribute sma where p.projet_is_public = 1 and p.projet_id = sma.sampma_projet_id;
SELECT
...
FROM dod_ometa.project p, dod_ometa.sample_meta_attribute sma
