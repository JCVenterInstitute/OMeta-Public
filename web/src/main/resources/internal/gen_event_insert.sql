-- EVENT
-- select e.* from dod_ometa. project p, dod_ometa. event e where p.projet_is_public = 1 and p.projet_id = e.event_projet_id;
SELECT
...
FROM dod_ometa.project p, dod_ometa.event e
