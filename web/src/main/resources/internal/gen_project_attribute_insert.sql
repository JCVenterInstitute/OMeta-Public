-- PROJECT_ATTRIBUTE
-- select pa.* from dod_ometa. project p, dod_ometa. project_attribute pa where p.projet_is_public = 1 and p.projet_id = pa.projea_projet_id;
SELECT
...
FROM dod_ometa.project p, dod_ometa.project_attribute pa
