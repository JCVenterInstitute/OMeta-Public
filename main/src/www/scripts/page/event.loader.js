var _utils = {
    ...
    callbacks = {
        ...
        meta: function(data, en) {
            ...
            var requireImgHtml = '<img class="attributeIcon" src="images/icon/info_r.png" style="float: right;"/>';
                    ...
                    if(isSelect) { //select box for option values
                        ...
                        if(maDatatype === 'file') { //file
                            ...
                            inputElement +=
                                ...
                                '  <label class="input-group-addon" style="padding:4px;"><span><i class="fa fa-calendar"></i></span></label>' +
